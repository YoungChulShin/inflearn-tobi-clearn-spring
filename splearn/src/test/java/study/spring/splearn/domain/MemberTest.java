...
class MemberTest {
  ...
  void setUp() {
    ...
    member = Member.register(new MemberRegisterRequest("test@test.com", "shin", "secret"), passwordEncoder);
  }
  ...
  void invalidEmail() {
    assertThatThrownBy(() ->
        Member.register(new MemberRegisterRequest("invalid email", "shin", "secret"), passwordEncoder)
